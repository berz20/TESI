...
def center_split():
    ...
    int_popt_int, int_pcov_int = curve_fit(Deviation_plotter, B, int_peak_int, sigma= int_peak_int_err)
    int_perr_int = np.sqrt(np.diag(int_pcov_int))
    int_popt_ext, int_pcov_ext = curve_fit(Deviation_plotter, B, int_peak_ext, sigma= int_peak_ext_err)
