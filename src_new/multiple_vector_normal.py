...
def mult_vect():
    ...
    c = ['tab:blue','tab:orange','tab:green','tab:red','tab:purple','tab:brown','tab:pink','tab:grey','tab:olive','tab:cyan','tab:blue']
    for i in range(0, len(B_xyz_X)):
...
mult_vect()
plt.savefig(f'{OUTIMGDIR}/multiple_vector_normal.pdf')
# plt.show()
# File used 
# 20220802-1031-50
# 20220802-1101-15
